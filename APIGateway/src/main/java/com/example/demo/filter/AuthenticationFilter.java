...
public class AuthenticationFilter extends AbstractGatewayFilterFactory<AuthenticationFilter.Config> {
	...
	private boolean isAuthorized(String role, String path, String method) {
		if ("DOCTOR".equalsIgnoreCase(role)) {
			return (path.startsWith("/appointment") || path.startsWith("/prescription") 
					|| path.startsWith("/doctor") || path.startsWith("/auth/getDocInfo") 
			...
			return (path.startsWith("/appointment/book") || path.startsWith("/appointment/delete") 
					...
					|| path.startsWith("/prescription/show") || path.startsWith("/prescription/getByAppointmentId") 
					|| path.startsWith("/patient") || (path.startsWith("/doctor") && method.equalsIgnoreCase("GET"))
